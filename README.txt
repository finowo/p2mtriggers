...
On github click on the 'Code' and do 'Download ZIP' 
...
SP and Coop folders HAVE TO GO INSIDE OF YOUR CFG FOLDER 'Steam\steamapps\common\Portal 2\portal2\cfg'
...
Along with that please put the exec lines below in your autoexec.cfg 

exec SPmtriggers.cfg
exec Coopmtriggers.cfg

After everything is setup you need to do sar_speedrun_IL 1 and after every finished run you will have to reset LiveSplit.
You can make a global hotkey to reset and set it to be your restart key or something similar.
